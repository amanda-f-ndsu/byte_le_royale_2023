...
-- Started on 2023-01-26 20:25:07 CST
...
--
-- TOC entry 2 (class 3079 OID 33540)
...
--
-- TOC entry 229 (class 1255 OID 33551)
...
--
-- TOC entry 232 (class 1255 OID 33552)
...
--
-- TOC entry 233 (class 1255 OID 33553)
-- Name: get_errors_for_submission(integer, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_errors_for_submission(submissionid integer, teamid uuid) RETURNS TABLE(run_id integer, submission_id integer, error_text character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
-- Created by: Sean Hagen
...
ALTER FUNCTION public.get_errors_for_submission(submissionid integer, teamid uuid) OWNER TO postgres;

--
-- TOC entry 234 (class 1255 OID 33554)
...
--
-- TOC entry 271 (class 1255 OID 33559)
...
BEGIN
-- Created by: Sean Hagen
-- Written on: 11/1/2021 (Updated 11/10/2022)
...
CREATE FUNCTION public.insert_error(subid integer, runid integer, err character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
-- Created by: Sean Hagen
...
CREATE FUNCTION public.insert_run(sub_id integer, score integer, group_run_id integer, seedid integer) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE runid int;
begin
...
CREATE FUNCTION public.insert_run(winn integer, player1 integer, player2 integer, grouprunid integer, seedid integer) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE runid int;
begin
...
--
-- TOC entry 230 (class 1255 OID 33578)
...
--
-- TOC entry 231 (class 1255 OID 33579)
...
--
-- TOC entry 270 (class 1255 OID 50030)
-- Name: truncate_tables(character varying); Type: FUNCTION; Schema: public; Owner: byte_api
--
...
ALTER FUNCTION public.truncate_tables(username character varying) OWNER TO byte_api;
...
--
-- TOC entry 203 (class 1259 OID 33580)
...
--
-- TOC entry 204 (class 1259 OID 33586)
...
--
-- TOC entry 205 (class 1259 OID 33592)
...
--
-- TOC entry 206 (class 1259 OID 33596)
...
--
-- TOC entry 207 (class 1259 OID 33598)
...
--
-- TOC entry 209 (class 1259 OID 33608)
...
--
-- TOC entry 210 (class 1259 OID 33610)
...
--
-- TOC entry 211 (class 1259 OID 33616)
...
--
-- TOC entry 212 (class 1259 OID 33618)
...
--
-- TOC entry 213 (class 1259 OID 33622)
...
--
-- TOC entry 214 (class 1259 OID 33624)
...
--
-- TOC entry 215 (class 1259 OID 33629)
...
--
-- TOC entry 216 (class 1259 OID 33633)
...
--
-- TOC entry 218 (class 1259 OID 33639)
...
--
-- TOC entry 2923 (class 2604 OID 33641)
...
--
-- TOC entry 2926 (class 2604 OID 33642)
...
--
-- TOC entry 2927 (class 2604 OID 33643)
...
--
-- TOC entry 2929 (class 2604 OID 33644)
...
--
-- TOC entry 2932 (class 2604 OID 33645)
...
--
-- TOC entry 2934 (class 2604 OID 33646)
...
--
-- TOC entry 2937 (class 2606 OID 33648)
...
--
-- TOC entry 2940 (class 2606 OID 33650)
...
--
-- TOC entry 2943 (class 2606 OID 33652)
...
--
-- TOC entry 2945 (class 2606 OID 33654)
...
--
-- TOC entry 2947 (class 2606 OID 33656)
...
--
-- TOC entry 2949 (class 2606 OID 33658)
...
--
-- TOC entry 2951 (class 2606 OID 33660)
...
--
-- TOC entry 2953 (class 2606 OID 33662)
...
--
-- TOC entry 2938 (class 1259 OID 33663)
...
--
-- TOC entry 2941 (class 1259 OID 33664)
...
--
-- TOC entry 2954 (class 2606 OID 33665)
...
--
-- TOC entry 2955 (class 2606 OID 33670)
...
--
-- TOC entry 2957 (class 2606 OID 33675)
...
--
-- TOC entry 2958 (class 2606 OID 33680)
...
--
-- TOC entry 2964 (class 2606 OID 33685)
...
--
-- TOC entry 2959 (class 2606 OID 33690)
...
--
-- TOC entry 2960 (class 2606 OID 33695)
...
--
-- TOC entry 2961 (class 2606 OID 33700)
...
--
-- TOC entry 2962 (class 2606 OID 33705)
...
--
-- TOC entry 2956 (class 2606 OID 33710)
...
--
-- TOC entry 2965 (class 2606 OID 33715)
...
--
-- TOC entry 2966 (class 2606 OID 33720)
...
--
-- TOC entry 2967 (class 2606 OID 33725)
...
--
-- TOC entry 2963 (class 2606 OID 33730)
...
-- Completed on 2023-01-26 20:25:07 CST
